...
const optionsObj = {
  //   root: null, // element that target element intersects => null(default) = viewport => If set to parent element, it tracks all children element inside of it --> Not used much
  threshold: 1,
